...
setInterval(updateCountdown, 1000);
    ...
    const familyNames = {
      ...
      Fernanda_Gonzalez_Novia: "Fernanda Gonzalez",
      Familia_Amada: "Amada Leticia Estrada & Familia",
      //FAMILIA DE CARLOS
  ...
  document.getElementById("confirmYesBtn").addEventListener("click", function() {
    ...
    if (tickets === "0") {
      ...
      message += `Con mucha alegría, La *${familyNames[sub]}* de la Novia(o) *${family}* confirma la asistencia de *${tickets} personas* a la boda el *20 de Diciembre de 2025*.\n\n` +
                 `*Dress Code:* Semi-Formal (Se recomienda llevar abrigo o saco debido a la temporada invernal, para mayor comodidad\n\n` +
